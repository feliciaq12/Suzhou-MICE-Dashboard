...
const THEME_COLORS = {
  ...
  pie: ["#2E7D32", "#66BB6A", "#A5D6A7", "#81C784", "#43A047", "#C8E6C9", "#388E3C", "#AED581", "#7CB342", "#DCEDC8"]
};
      ...
      datasets: [
        {
          ...
          pointRadius: 4,
          pointHoverRadius: 5,
          pointBackgroundColor: THEME_COLORS.primaryBorder
        }
      ]
    },
    options: {
      ...
      datasets: [
        {
          ...
          backgroundColor: THEME_COLORS.pie.slice(0, sectorEntries.length),
          borderColor: "#ffffff",
          borderWidth: 1
        }
      ]
